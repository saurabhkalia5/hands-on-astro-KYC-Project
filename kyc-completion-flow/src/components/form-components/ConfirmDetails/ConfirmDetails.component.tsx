  ...
  return (
    ...
    <div className="card">
      ...
      <div className="documents">
        ...
        <div className="document-placeholder">
          <img src={currentUser.documents.signature} alt="Signature" className="document-image" />
        </div>
      </div>
    </div>
    ...
    <div className="terms">
      <label>
        <input type="checkbox" aria-label="Agree to terms and conditions" /> I agree to the <a href="#">Terms & Conditions</a>
      </label>
    </div>
    <div className="buttons">
      <button className="next-btn" aria-label="Proceed to the next step">Next</button>
      <button className="skip-btn" aria-label="Skip for now">Skip for now</button>
    </div>
  </div>
  );
};
